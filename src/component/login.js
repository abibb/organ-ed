...
class Login extends Component {
  ...
  handleRegister(event) {
    if (
      !this.state.showsAgreementError &&
      this.validateEmail(this.state.username) &&
      this.state.password &&
      !this.state.showTyperror
    ) {
    ...
    return (
      <div className="App">
        <header className="App-header">
          ...
          <div className="logoTitle">Organ-ed</div>
        </header>
                ...
                <div className="row">
                  <div className="login-field">
                    <input
                      required
                      placeholder="Email"
                      className="text-input-input autofocus"
                      type="email"
                      name="username"
                  ...
                  <div className="dropdown fullWidth">
                    <button
                      className="btn btn-secondary dropdown-toggle fullWidth"
                      type="button"
                      id="registerType"
                    ...
                    <div
                      className="dropdown-menu fullWidth"
                      aria-labelledby="registerType"
                    >
                      <a
                  ...
                  <div
                    className={
                      this.props.loginFailed
                        ...
                        : "text-input-error-wrapper success"
                    }
                  >
                    {this.props.loginMsg}
                  </div>
                  {this.state.showTyperror ? (
                    <div className="text-input-error-wrapper">
                      Please choose type
                    </div>
                  ) : null}
                  <input
                  ...
                  />
                  <a href="" className="ForgotPass" onClick={this.showRegister}>
              ...
              <form>
                <div className="row">
                  ...
                  <div className="remember-me">
                    ...
                    <input
                      type="checkbox"
                      value={this.state.showsAgreementError ? "FALSE" : "TRUE"}
                      id="rememberMe"
                      name="agreementCheck"
                      onChange={this.handleAgreement}
                    />
                    I agree to{" "}
                    <a target="_blank" href="html/agreement.html">
                      Terms & conditions
                    </a>
                  </div>
                  <div
